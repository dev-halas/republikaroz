<section class="awards">
  <div class="container">
    <div class="awardsDesc animate-zoom-in">
      ...
      <div class="awardsDescMore">
        <div></div>
        <p>Republika Róż by Andrzej Gołąbek to restauracja, która zdobyła uznanie zarówno wśród gości, jak i w świecie
        gastronomii. Jej wyjątkowa kuchnia i niepowtarzalna atmosfera zostały docenione przez liczne prestiżowe
        wyróżnienia.</p>
      </div>
    ...
    <div class="awardsContent">
      <div class="awardsItem animate-fade-up">
        ...
        <h4>4 Widelce<br>Best of Award of Excellence</h4>
      ...
      <div class="awardsItem animate-fade-up">
        ...
        <h4>Złoty widelec</h4>
        <p>w kategorii Kuchnia AutorskaPrzyznany podczas XIII edycji konkursu „Polska od Kuchni” organizowanego przez
          Fundację WIP oraz Stowarzyszenie Kucharzy Polskich. To jedno z najbardziej prestiżowych wyróżnień w polskiej
          gastronomii, potwierdzające najwyższą jakość i oryginalność serwowanych dań.</p>
      </div>
    </div>
  </div>
</section>